            ...
            TextUtils.isEmpty(height) -> {
                ...
                var hasil = ""
                    ...
                    R.id.btn_calculate_volume -> {
                        hasil = mainViewModel.getVolume().toString()
                        activityMainBinding.tvResult.text = hasil
                        gone()
                    }
                    R.id.btn_calculate_surface_area -> {
                        hasil = mainViewModel.getSurfaceArea().toString()
                        activityMainBinding.tvResult.text = hasil
                        gone()
                    }
                    R.id.btn_calculate_circumference -> {
                        hasil = mainViewModel.getCircumference().toString()
                        activityMainBinding.tvResult.text = hasil
                        gone()
                    }
                }
